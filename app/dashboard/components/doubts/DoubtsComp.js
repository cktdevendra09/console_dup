        ...
        <div className="flex flex-row px-2 py-3 mx-3">
          ...
          <div className="flex flex-col mb-2 ml-4 mt-1">
            ...
            <div className="flex w-full mt-1">
              <div className="text-blue-700 text-xs mr-1 cursor-pointer">SEO</div>
              <div className="text-gray-400 text-xs">• 30 seconds ago</div>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              <div
                ...
                className={`relative overflow-hidden rounded-xl ${
                  i < 2 ? "col-span-3 max-h-[14rem]" : "col-span-2 max-h-[10rem]"
                }`}
              >
                {i === 4 && (
