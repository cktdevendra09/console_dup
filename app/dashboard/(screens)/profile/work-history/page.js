          ...
          <div className="space-y-5">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  defaultValue="Senior Project Director"
              ...
              <div>
                ...
                <input
                  type="text"
                  defaultValue="Innovate Tech Solutions"
                  className="w-full mt-1 px-3 py-2 text-sm rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                rows="4"
                defaultValue="Leading cross-functional teams to deliver enterprise-scale applications. Focused on agile methodologies and technical excellence."
