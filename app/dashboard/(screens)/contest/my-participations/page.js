      ...
      <header className="h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 px-6 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-slate-800">
            ...
            <img alt="Profile" className="w-9 h-9 rounded-full object-cover ring-2 ring-primary/20" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCTY1hfrDU1dJC12v4FrQpLk31kylwtbX4un4p1teC0GyYNZkn_4q-KKdlKcnHyxCo0ngZWFxv1dn3zU2j5srksRZZtKXfSmXS5Jlcbnp0QnSuHum_Wgf0pw7l_LCg4DK7QACaL3zYgpF7WrKVUvoiDtmB6rNk82H0VX3n56DuOAikPGeSuHgM7WdgEkAhKXp-euvHY7oqZEt6X77LyWjgK4ELyaYARJ8dS4K2nEXvCm_F7Ahm3lOt13YnpX8oBm5dS3pjAZM0-Miw_" />
          </div>
        </div>
      </header>
...
function StatCard({ title, value, subtitle, icon, trend, valueColor, trendColor }) {
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl group hover:border-primary/50 transition-colors">
